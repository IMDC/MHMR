...
const DataAnalysisLineGraph = () => {
  ...
  const dateOptions = [
    {label: new Date('2024-04-25T23:59:59').toDateString(), value: 0},
    {label: new Date('2024-04-26T23:59:59').toDateString(), value: 1},
    {label: new Date('2024-04-27T23:59:59').toDateString(), value: 2},
  ];
