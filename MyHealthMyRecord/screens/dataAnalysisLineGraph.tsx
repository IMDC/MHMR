                ...
                {freqDayArray[date]?.map((value, index) => (
                    <Circle
                        ...
                        onPressIn={() => {
                            ...
                            console.log("start");
                            Alert.alert('View video(s) with this data', value.videoIDs.toString(), [
                                { text: 'OK', onPress: () => console.log("go to video function here") },
                            ]);
                        }}
                        onPressOut={() => {
                        ...
                        <ScrollView horizontal={true}>
                            <View style={{ flex: 1, marginLeft: 10, marginRight: 10, width: windowWidth * 1.5 }}>
                                ...
                                <XAxis
                                    ...
                                    formatLabel={(value, index) => hours[freqDayArray[0][index].label]}
                                    labelStyle={{ margin: 5 }}
